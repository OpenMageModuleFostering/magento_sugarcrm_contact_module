<?php
class Offshoreevolution_Sugarcrm_Adminhtml_AjaxController extends Mage_Adminhtml_Controller_Action
{
	public function FetchmoduleAction()
	{
		$this->loadLayout();	
	...
	public function SyncnewfieldsAction()
	{
		$read 	= Mage::getSingleton('core/resource')->getConnection('core_read');
		$write  = Mage::getSingleton('core/resource')->getConnection('core_write');
		$ObjectSugar = Mage::helper('sugarcrm')->getSugarObject();
		$prefix = Mage::getConfig()->getTablePrefix();
