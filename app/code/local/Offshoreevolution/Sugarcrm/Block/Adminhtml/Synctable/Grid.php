<?php
class Offshoreevolution_Sugarcrm_Block_Adminhtml_Synctable_Grid extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	...
	public function getHeaderText()
    {
		...
		return 'Magento Customer To SugarCRM '.$module.' Mapping';
    }
}
?>