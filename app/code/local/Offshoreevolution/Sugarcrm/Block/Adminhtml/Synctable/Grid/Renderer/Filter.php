<?php
class Offshoreevolution_Sugarcrm_Block_Adminhtml_Synctable_Grid_Renderer_Filter extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row)
    {
		...
		if(Mage::getSingleton('core/session')->getFiltermodule() == 'Contacts')
		{
			$CustomerDetail = Mage::helper('sugarcrm')->getContactsArray();
			$CustomerArray = array();
			...
			$BillingAddressFields = Mage::helper('sugarcrm')->getAddressEntityList();
			$BillingArray = array();
			$ShippingArray = array();
